...
const Formulario = () => {
    //State para guardar los datos del paciente
    ...
    useEffect( () => {
        //Verificamos que el paciente tenga algo
        if( paciente?.nombre ) {
    ...
    const handleSubmit = ( e ) => {
        ...
        //Guardamos los pacientes en la funcion
        guardarPaciente( {
            nombre,
            propietario,
            email,
  ...
  return (
    <>
        ...
        <p className="text-xl text-center mb-10 mt-5">
            Añade tus pacientes y <span className="text-indigo-600 font-bold">Admistralos</span>
        </p>
