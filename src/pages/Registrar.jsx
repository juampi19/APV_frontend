...
const Registrar = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (password.length < 6) {
            setAlerta({ msg: 'Password debe tener minimo 6 caracteres', error: true });
            return;
        }

        setAlerta({});

        //Creando el usuario en la api con axios
        try {
    ...
    return (
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-5xl">Crea tu Cuenta y Administra <span className="text-black"> tus Pacientes</span> </h1>
            </div>
            ...
            <div className='mt-20 md:mt-5 shadow-lg py-5 px-10 rounded-xl bg-white'>
                ...
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <input type="submit" value="Crear Cuenta" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 lg:w-auto" />

                </form>

                <nav className='mt-10 xl:flex xl:justify-between'>
                    ...
                    <Link
                        className='block text-center my-5 text-gray-500'
                        to="/olvide-password">Olvide mi Passwword</Link>
