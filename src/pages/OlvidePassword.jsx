...
const OlvidePassword = () => {
  ...
  //Hacemos el submit al formulario
    ...
    <>
      ...
      <div className='mt-20 md:mt-5 shadow-lg py-5 px-10 rounded-xl bg-white'>
        ...
        onSubmit={ handleSubmit }>
          ...
          <input type="submit" value="Recuperar cuenta" className="bg-indigo-700 w-full py-3 px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 lg:w-auto" />
