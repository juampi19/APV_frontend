...
const ConfirmarCuenta = () => {
  ...
  useEffect( () => {
    ...
    const confirmarCuenta = async () => {
      ...
      try {
        //Hacemos la peticion get a confirmar cuenta
  ...
  return (
    <>
      <div>
        <h1 className="text-indigo-600 font-black text-5xl">Confirma tu Cuenta y Comienza a Administrar <span className="text-black"> tus Pacientes</span> </h1>
      </div>
